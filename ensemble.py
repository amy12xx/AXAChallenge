"""
This is Sebastian Raschka's code for an ensemble, which I believe is now part of scikit-learn. Adding it in this repo for completeness, since I have used it as a standalone file
